                    ...
                    <div class="queryMessage">
                        ...
                        <div class="blog-posts hfeed index-post-wrap">
                            ...
                            @php $a = explode(",",$image->item_img); @endphp
                                 @foreach($a as $b)
                                <a class="entry-image-wrap is-image" href="blog-post_22.html" title="आप कल जो थे उससे हमेशा ज्यादा बड़े हो | "><img src="{{ url('item_img') }}/{{ $b }}" alt="">
                                </a>@endforeach
                                ...
                                <div class="entry-header">
                                    ...
                                    <p class="entry-excerpt excerpt">  {!! (Str::words($desdata,40)) !!}</p> --}}

                                    {{-- <p class="entry-excerpt excerpt">{{ Str::limit($image->description, 150) }}
                                    </p> --}}

                                    <div class="entry-meta">
                                        <span class="entry-author mi"><span class="by sp">by</span><span class="author-name">{{$image->name}}</span></span>
                                        <span class="entry-time mi"><span class="sp">-</span><time class="published" >{{ \Carbon\Carbon::parse ($image->created_at)->format('M d ,Y')}}</time></span>
                                    </div>
            ...
            <div class="sidebar gnews-free-widget-ready section" id="sidebar" name="Sidebar">
                ...
                <div class="widget PopularPosts" data-version="2" id="PopularPosts2">
                    ...
                    {{-- @foreach($product as $popular)
                        ...
                        {{-- <?php $cat = App\Category::with(["product"])->orderBy('id','desc')->LIMIT(5)->get();   ?> --}}

                        <?php $product=App\Product::orderBy('id','desc')->LIMIT(4)->get(); ?>
